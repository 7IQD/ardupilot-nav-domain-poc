...
| **Framework/** | ELT and implementation guidelines, including the LRU/SRU reporting framework (`NAV_MART_IMPLEMENTATION_FRAMEWORK.md`). |
...
2. **Framework** – Implement ELT pipelines, LRU/SRU live reporting, and phase-wise assertions.
...
* **Traceability** – UI panels, ELT outputs, and NAV_REPORT sections are fully mapped.
